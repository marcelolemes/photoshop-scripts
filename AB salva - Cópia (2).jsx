...
var tempo = data.getTime();
    	...
    	var relat = new File("//Servidor/d/PLANILHAS EXCEL - NÃO DELETARRRRRRR/Auto/"+contrato+" "+ album +op+".txt");
	relat.open('a');
	relat.writeln("Template: AB. Iniciado em: "+  data.getHours() + ':' + data.getMinutes() + ':' + data.getSeconds() + ' h ');
	relat.close();

var curso = new File("//Servidor/d/PLANILHAS EXCEL - NÃO DELETARRRRRRR/Cursos/"+contrato+".txt");

curso.open('a');
curso.writeln("Operador:" +op+" "+album+" "+ "Iniciado às: "+  data.getHours() + ':' + data.getMinutes() + ':' + data.getSeconds() + ' h ');
