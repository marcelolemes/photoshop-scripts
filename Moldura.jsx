...
//var relat = new File(activeDocument.path+'/'+"x "+op+".txt");
	...
	//relat.open('a');
	//relat.writeln("Template: Moldura feita. Iniciado em: "+ data.getDate() + "/" + (data.getMonth()+1) + "/" + data.getFullYear() + ", às "+  data.getHours() + ":" + data.getMinutes() + " h.");
	//relat.close();
    ...
    open(jpegOriginal);
	jpegFileLA = new File(activeDocument.path + "/" +"X "+pasta+" "+nome+".JPG");
